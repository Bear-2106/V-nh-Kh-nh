    ...
    public class PoiController : AdminControllerBase
    {
        ...
        private static PoiEditViewModel BuildPoiModel(IFormCollection form)
        {
            var model = new PoiEditViewModel
            {
                ...
                TtsTextVi = form["TtsTextVi"].ToString().Trim(),
                TtsTextEn = form["TtsTextEn"].ToString().Trim(),
                TtsTextZh = form["TtsTextZh"].ToString().Trim(),
                TtsTextFr = form["TtsTextFr"].ToString().Trim(),
                TtsTextRu = form["TtsTextRu"].ToString().Trim(),
                ImageUrl = form["ImageUrl"].ToString().Trim(),
                IsActive = IsChecked(form, "IsActive")
            };

            model.TtsTextVi = string.IsNullOrWhiteSpace(model.TtsTextVi)
                ? model.Description
                : model.TtsTextVi;
